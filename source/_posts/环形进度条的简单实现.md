...
##### CAShaprLayer
一个很强大的CALayer子类，由于其可以添加path路径，因此可以绘制出很多复杂的图形。这里也引用一篇之前看过的不错的博客：[关于CAShapeLayer和UIBzierPath的使用](http://www.cocoachina.com/ios/20160214/15251.html)
...
```
对于CAShapeLayer，stokeEnd和strokestart属性都直接动画操作。
